...
<head>
    ...
    <title>Kantor desa Pengadang</title>
    ...
    <div id="mainCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="images/pengadang.jpg" alt="...">
                <div class="carousel-caption welcome">
                    <h2 class="animated bounceInRight">Selamat Datang</h2>
                    <h3 class="animated bounceInLeft">Website Pengaduan Masyarakat desa Pengadang</h3>
                </div>
            </div>
            <div class="item">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box">
                        ...
                        <div class="info">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item list-group-item-success"><a href="http://www.bangkalankab.go.id/v4/">Website Pemerintah Desa Pengadang</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- End Facebook Feed -->
